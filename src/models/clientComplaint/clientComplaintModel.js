...
const ClientComplaintSchema = new mongoose_1.Schema({
...
const ClientComplaint = mongoose_1.default.model("ClientComplaint", ClientComplaintSchema);
exports.default = ClientComplaint;
