...
const AnnualComplaintSchema = new mongoose_1.Schema({
...
const AnnualComplaint = mongoose_1.default.model("AnnualComplaint", AnnualComplaintSchema);
exports.default = AnnualComplaint;
