...
const monthlyComplaintSchema = new mongoose_1.Schema({
...
const monthlyComplaint = mongoose_1.default.model("MonthlyComplaint", monthlyComplaintSchema);
exports.default = monthlyComplaint;
